...
> [!NOTE]
>  การใช้กระบวนการอาจส่งผลกระทบต่อข้อกำหนดสิทธิการใช้งานสำหรับ PowerApps และโฟลว์ สำหรับข้อมูลเพิ่มเติม ดู[ ข้อกำหนดสิทธิ์การใช้งานของเอนทิตี](https://docs.microsoft.com/powerapps/maker/common-data-service/data-platform-entity-licenses) 
...
สำหรับข้อมูลเพิ่มเติมสำหรับนักพัฒนา ดูหัวข้อคู่มือสำหรับนักพัฒนา [ทำให้กระบวนการทางธุรกิจของคุณในการมีส่วนร่วมของลูกค้าเป็นแบบอัตโนมัติ](https://docs.microsoft.com/dynamics365/customer-engagement/developer/automate-business-processes-customer-engagement
)
